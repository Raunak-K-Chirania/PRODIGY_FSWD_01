...
const Header = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center mt-20 px-4 text-center text-gray-800">
      ...
      <p className="mb-8 max-w-md">Let's started with a quick product tour and we will have you up and running in no time!</p>
